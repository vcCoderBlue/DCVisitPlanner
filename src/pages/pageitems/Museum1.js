...
class Museum1 extends Component {
  onClick() {
      window.scrollTo(0, 0)
  }
  render() {
    return (
      <div>
        <div id="content1">
            ...
            <div className="favorite">
              <div>
                <Main1 addFavsfavorite={() => this.props.addLink(
                  <ul><li><Font6 /><Link to="/DCVisitPlanner/Museums/Museum1"> Arlington National Cemetary</Link></li></ul>)} />
              </div>
            </div>
          </nav1>
          <aside1>
          <div className="pic">
            <Font6 /> <br />
              <a href= "https://www.arlingtoncemetery.mil/#/" target="_blank" rel="noopener noreferrer">Website</a> <br/>
              <a href= "https://www.google.com/maps" target="_blank" rel="noopener noreferrer">Directions</a> <br/>
          </div>
          </aside1>
          <header1>
            <h3>Arlington National Cemetary</h3>
          </header1>
          <main1>
...
export default connect(mapStateToProps, mapDispatchToProps)(Museum1);
