...
class Transport2 extends Component {
  onClick() {
      window.scrollTo(0, 0)
  }
  render() {
    return (
      <div>
        <div id="content1">
            ...
            <div className="favorite">
              <div>
                <Main1 addFavsfavorite={() => this.props.addLink(
                  <ul><li><Font7 /><Link to="/DCVisitPlanner/Transport/Transport2"> Metro</Link></li></ul>)} />
              </div>
            </div>
          </nav1>
          <aside1>
          <div className="pic">
            <Font7 /> <br />
              <a href= "https://www.wmata.com/" target="_blank" rel="noopener noreferrer">Website</a> <br/>
          </div>
          </aside1>
          <header1>
            <h3>Metro</h3>
...
export default connect(mapStateToProps, mapDispatchToProps)(Transport2);
