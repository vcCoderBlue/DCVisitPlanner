...
class Shopping2 extends Component {
  onClick() {
      window.scrollTo(0, 0)
  }
  render() {
    return (
      <div>
        <div id="content1">
            ...
            <div className="favorite">
              <div>
                <Main1 addFavsfavorite={() => this.props.addLink(
                  <ul><li><Font5 /><Link to="/DCVisitPlanner/Shopping/Shopping2"> Fashion Centre at Penatagon City</Link></li></ul>)} />
              </div>
            </div>
          </nav1>
          <aside1>
          <div className="pic">
            <Font5 /> <br />
              <a href= "http://www.simon.com/mall/fashion-centre-at-pentagon-city" target="_blank" rel="noopener noreferrer">Website</a> <br/>
              <a href= "https://www.google.com/maps" target="_blank" rel="noopener noreferrer">Directions</a> <br/>
          </div>
          </aside1>
          <header1>
            <h3>Fashion Centre at Penatagon City</h3>
          </header1>
          <main1>
...
export default connect(mapStateToProps, mapDispatchToProps)(Shopping2);
