...
class Museum4 extends Component {
  onClick() {
      window.scrollTo(0, 0)
  }
  render() {
    return (
      <div>
        <div id="content1">
            ...
            <div className="favorite">
              <div>
                <Main1 addFavsfavorite={() => this.props.addLink(
                  <ul><li><Font6 /><Link to="/DCVisitPlanner/Museums/Museum4"> National World War II Memorial</Link></li></ul>)} />
              </div>
            </div>
          </nav1>
          <aside1>
          <div className="pic">
            <Font6 /> <br />
              <a href= "https://www.wwiimemorial.com/" target="_blank" rel="noopener noreferrer">Website</a> <br/>
              <a href= "https://www.google.com/maps" target="_blank" rel="noopener noreferrer">Directions</a> <br/>
          </div>
          </aside1>
          <header1>
            <h3>National World War II Memorial</h3>
          </header1>
          <main1>
...
export default connect(mapStateToProps, mapDispatchToProps)(Museum4);
