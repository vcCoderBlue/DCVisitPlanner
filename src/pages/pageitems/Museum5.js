...
class Museum5 extends Component {
  onClick() {
      window.scrollTo(0, 0)
  }
  render() {
    return (
      <div>
        <div id="content1">
            ...
            <div className="favorite">
              <div>
                <Main1 addFavsfavorite={() => this.props.addLink(
                  <ul><li><Font6 /><Link to="/DCVisitPlanner/Museums/Museum5"> United States Holocaust Memorial Museum</Link></li></ul>)} />
              </div>
            </div>
          </nav1>
          <aside1>
          <div className="pic">
            <Font6 /> <br />
              <a href= "https://www.ushmm.org/" target="_blank" rel="noopener noreferrer">Website</a> <br/>
...
export default connect(mapStateToProps, mapDispatchToProps)(Museum5);
