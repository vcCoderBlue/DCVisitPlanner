...
class Transport1 extends Component {
  onClick() {
      window.scrollTo(0, 0)
  }
  render() {
    return (
      <div>
        <div id="content1">
            ...
            <div className="favorite">
              <div>
                <Main1 addFavsfavorite={() => this.props.addLink(
                  <ul><li><Font11 /><Link to="/DCVisitPlanner/Transport/Transport1"> capital bikeshare</Link></li></ul>)} />
              </div>
            </div>
          </nav1>
          <aside1>
          <div className="pic">
            <Font11 /> <br />
              <a href= "https://www.capitalbikeshare.com" target="_blank" rel="noopener noreferrer">Website</a> <br/>
          </div>
          </aside1>
          <header1>
...
export default connect(mapStateToProps, mapDispatchToProps)(Transport1);
