    ...
    return (
      <div>
        <div id="content1">
            ...
            <div className="favorite">
              <div>
                <Main1 addFavsfavorite={() => this.props.addLink(
                  <ul><li><Font5 /><Link to="/DCVisitPlanner/Shopping/Shopping3"> Georgetown</Link></li></ul>)} />
              </div>
            </div>
          </nav1>
          <aside1>
          <div className="pic">
            <Font5 /> <br />
              <a href= "http://www.georgetowndc.com/explore/fashion/" target="_blank" rel="noopener noreferrer">Website</a> <br/>
...
export default connect(mapStateToProps, mapDispatchToProps)(Shopping3);
