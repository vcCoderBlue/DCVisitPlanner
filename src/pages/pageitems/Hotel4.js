    ...
    return (
      <div>
        <div id="content1">
            ...
            <div className="favorite">
              <div>
                <Main1 addFavsfavorite={() => this.props.addLink(
                  <ul><li><Font3 /><Link to="/DCVisitPlanner/Hotels/Hotel4"> The Watergate Hotel</Link></li></ul>)} />
              </div>
            </div>
          </nav1>
          <aside1>
          <div className="pic">
            <Font3 /> <br />
              <a href= "https://www.thewatergatehotel.com/" target="_blank" rel="noopener noreferrer">Website</a> <br/>
              <a href= "https://www.google.com/maps" target="_blank" rel="noopener noreferrer">Directions</a> <br/>
          </div>
          </aside1>
          <header1>
            <h3>The Watergate Hotel</h3>
          </header1>
          <main1>
...
export default connect(mapStateToProps, mapDispatchToProps)(Hotel4);
