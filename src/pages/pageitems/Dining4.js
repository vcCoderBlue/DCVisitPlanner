...
class Dining4 extends Component {
  onClick() {
      window.scrollTo(0, 0)
  }
  render() {
    return (
      <div>
        <div id="content1">
            ...
            <div className="favorite">
              <div>
                <Main1 addFavsfavorite={() => this.props.addLink(
                  <ul><li><Font4 /><Link to="/DCVisitPlanner/Dining/Dining4"> The Hamilton</Link></li></ul>)} />
              </div>
            </div>
          </nav1>
          <aside1>
          <div className="pic">
            <Font4 /> <br />
              <a href= "https://www.thehamiltondc.com/" target="_blank" rel="noopener noreferrer">Website</a> <br/>
...
export default connect(mapStateToProps, mapDispatchToProps)(Dining4);
